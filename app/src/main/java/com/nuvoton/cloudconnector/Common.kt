...
inline fun MainViewModel.debug(message: String) = Log.d(this.javaClass.simpleName, message)
inline fun RepositoryCommon.debug(message: String) = Log.d(this.javaClass.simpleName, message)
